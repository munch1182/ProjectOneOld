...
/**
 * @see <a href="https://www.quicklz.com/>quicklz</a>
 * <p>
 * Create by munch1182 on 2021/11/29 16:57.
 */
            ...
            if (level == 1) {
                ...
                if (matchlen >= 3 && src - o < 131071) {
                    ...
                    if (matchlen == 3 && offset <= 63) {
                        ...
                        fast_write(destination, dst, ((matchlen - 3) << 2) | ((long) offset << 6) | 2, 2);
                        dst += 2;
                    } else if (matchlen <= 33) {
                        fast_write(destination, dst, ((matchlen - 2) << 2) | ((long) offset << 7) | 3, 3);
                        dst += 3;
                    } else {
                        fast_write(destination, dst, ((long) (matchlen - 3) << 7) | ((long) offset << 15) | 3, 4);
                        dst += 4;
                    }
                } else {
                    destination[dst] = source[src];
