...
class LetterNavigationBarView @JvmOverloads constructor(
    ...
    init {
        ...
        textColor =
            attrsSet.getColor(R.styleable.LetterNavigationBarView_letter_textColor, colorGray)
        val textSize =
            attrsSet.getDimension(R.styleable.LetterNavigationBarView_letter_textSize, 40f)
        selectColor =
            attrsSet.getColor(R.styleable.LetterNavigationBarView_letter_selectColor, colorGray)
