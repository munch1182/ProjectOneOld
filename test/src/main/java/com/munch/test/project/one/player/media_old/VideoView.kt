package com.munch.test.project.one.player.media_old
...
class VideoView @JvmOverloads constructor(
    ...
    fun attachControllerView(
        ...
        controller.attachView(this, getSettingOrDef())
    ...
    override fun onSettingChange(setting: MediaSetting) {
        this.setting = setting
        controller?.onSettingChange(setting)
    }
