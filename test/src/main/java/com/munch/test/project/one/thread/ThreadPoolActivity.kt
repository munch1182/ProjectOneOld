...
/**
 * Create by munch1182 on 2021/4/28 9:50.
 */
class ThreadPoolActivity : BaseItemWithNoticeActivity() {

    private val testRun by lazy { TestRunnable() }
    private val oneCore by lazy { ThreadPoolHelper.newFixThread(1) }
