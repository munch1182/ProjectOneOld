...
class ImageLoaderOption {
    ...
    class Builder {
        ...
        fun into(targetView: View) {
            ImageLoadHelper.loadRes(options.strategy ?: ImageLoadHelper.checkStrategy(), targetView, options)
        }
        ...
        fun preload(context: Context) {
            ImageLoadHelper.preload(options.strategy ?: ImageLoadHelper.checkStrategy(),context, options)
        }
